...
<h6 id="__sections" class="uppercase text-dark/75 dark:text-light/75 font-bold text-sm">
Sections
</h6>
...
{#each headings as heading}
    <li
        class="heading list-none my-2 !pl-0 text-base text-dark/50 hover:text-dark dark:text-light/50 hover:dark:text-light transition-colors"
